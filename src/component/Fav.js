    ...
    <div className="App-fav">
      <div className="all-content-fav">
        <h2 className="title-fav">My Favorite</h2>
          {dataFav.build_set && dataFav.build_set.map((item,index) => {
            return (
                ...
                <div className="grid-fav">
                  ...
                  <div className="item">
                      <div className="content-fav">
                          <img src={item.mouse.url || "/image/iconmouse.png"} height="60px" width="60px"/>
                          <p className="font-title">{item.mouse.name || "Mouse"}</p>
                      </div>
                  </div>
                  <div className="item">
                      <div className="content-fav">
                          <img src={item.keyboard.url || "/image/iconkeyboard.png"} height="60px" width="60px"/>
                          <p className="font-title">{item.keyboard.name || "Keyboard"}</p>
                      </div>
                  </div>
                  <div className="item">
                      <div className="content-fav">
                          <img src={item.headset.url || "/image/iconheadset.png"} height="60px" width="60px"/>
                          <p className="font-title">{item.headset.name || "Headset"}</p>
                      </div>
                  </div>
                  <div className="item">
                      <div className="content-fav">
                          <img src={item.mousepad.url || "/image/iconmousepad.png"} height="60px" width="60px"/>
                          <p className="font-title">{item.mousepad.name || "Mousepad"}</p>
                      </div>
                  </div>
                  <div className="item">
                      <div className="content-fav">
                          <img src={item.microphone.url || "/image/iconmicrophone.png"} height="60px" width="60px"/>
                          <p className="font-title">{item.microphone.name || "Microphone"}</p>
                      </div>
                  </div>
                </div>
